const colors: Record<string, string> = {
  ...
  SPARE_ALLOCATED:    "bg-teal-100 text-teal-800 dark:bg-teal-900/40 dark:text-teal-300",
  PURCHASE_REQUESTED: "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300",
};

const labels: Record<string, string> = {
  PENDING: "Pending", APPROVED: "Approved", REJECTED: "Rejected",
  ASSIGNED: "Assigned", FIXED: "Fixed", ESCALATED: "Escalated",
  NEED_SPARE: "Need Spare", SPARE_ALLOCATED: "Spare Allocated",
